...
@endsection
  ...
  <div class="card">
    <div class="card-header">
      <h3 class="card-title">Bảng Hãng</h3>
    </div>
    <br>
    <div class="row">
      {{-- <div class="col-5"></div> --}}
      ...
      <div class="col-2" style="margin-left:20px">
          <button type="button" class="btn btn-primary"><a href="{{url('brand/create')}}" style="color: white"><i class="fa fa-plus-circle" style="font-size:20px; color: white"></i>Thêm mới</a></button>
      </div>
      <div class="col-5"></div>
    </div>
    <div class="card-body">
