...
@section('css')
    ...
    /* Định dạng cho form */
    .product-form {
        width: 80%; /* Độ rộng của form */
        margin: auto; /* Căn giữa form */
        padding: 20px; /* Khoảng cách viền ngoài */
    ...
    .product-form table {
        width: 100%;
        border-collapse: collapse; /* Xóa viền các ô trong bảng */
    }
    ...
    .product-form tr:hover {
        background-color: #f2f2f2; /* Màu nền khi di chuột vào hàng */
    }
          ...
          @csrf
            <div class="row">
                ...
                <div class="col-6">
                  ...
                  <input type="text" name="product_code" value="{{ old('product_code') }}" class="form-control" placeholder="">
                </div>
                
                <div class="col-6">
                  <label for="exampleInputName">Tên sản phẩm</label>
                  <input type="text" name="product_name" value="{{ old('product_name') }}" class="form-control" placeholder="">
                ...
                <div class="col-6">
                  ...
                  <input type="file" name="product_image[]" multiple accept="image" value="{{ old('product_image') }}" class="form-control" placeholder="">
                </div>
                <div class="col"></div>
            ...
            <div >
              <table id="prd_detail">
                ...
                <tbody>
                    <tr>
                      <td><input type="number" name="product_detail[1]" readonly  style="width:50px" class="form-control" value="1"></td>
                      <td> 
                    ...
                    <td>
                      <input type="number" class="form-control" style="min-width:400px" name="quantity[]">
                    </td>
                    <td>
