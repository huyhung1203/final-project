...
<div class="card">
  <div class="card-header">
    <h3 class="card-title">Bảng type</h3>
  </div>
  <br>
  <!-- /.card-header -->
  <div class="row">
    ...
    <div class="col-2" style="margin-left:20px">
        <button type="button" class="btn btn-primary"><a href="{{url('type/create')}}" style="color: white"><i class="fa fa-plus-circle" style="font-type:20px; color: white"></i>Thêm mới</a></button>
    </div>
    <div class="col-5"></div>
  </div>
  <div class="card-body">
      ...
      <tbody>
        <tr>
          @forelse ($type as $item)
              ...
              <td>
                <form action="{{url('type/'.$item->id)}}" method="POST">
                  <a href="{{url('type/'.$item->id.'/edit')}}">
