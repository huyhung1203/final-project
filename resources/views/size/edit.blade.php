...
<form action="{{url('size/'.$size->id)}}" method="POST" id="quickForm">
  @method('PUT')
  @csrf
  <div class="card-body">
    <div class="row">
        ...
        <div class="col-6">
          ...
          <input type="text" name="size_name" value="{{ $size->size_name }}" class="form-control" placeholder="">
